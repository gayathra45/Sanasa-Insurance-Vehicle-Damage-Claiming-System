                        ...
                        <div className="flex items-center gap-2 order-2 md:order-1">
                          {n.actionLabel === "View" ? (
                            <button
                              ...
                              className="w-[70px] h-[34px] flex items-center justify-center font-semibold text-xs rounded-full transition-all duration-150 active:scale-[0.98] cursor-pointer border-none bg-[#000080] hover:bg-[#000066] text-white shadow-xs"
                            >
                              View
                            </button>
                          ) : (
