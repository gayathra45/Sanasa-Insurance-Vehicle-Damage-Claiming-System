        ...
        <div className="flex-1 flex flex-col min-w-0 max-w-full overflow-x-hidden">
          ...
          <main className="flex-1 p-4 lg:p-8 bg-white overflow-y-auto">
            ...
            <div className="flex flex-col gap-3.5 mb-10">
              {loading ? (
                <SimpleLoader message="Fetching notifications..." theme="slate" />
                  ...
                  {steps.map((step, idx) => {
                    ...
                    return (
                      <div key={step.num} className="relative z-10 flex flex-col items-center flex-1">
                        ...
                        <span className={`text-[11px] font-bold mt-2 leading-none relative z-10 ${isActive ? "text-blue-600 font-bold" : isCompleted ? "text-slate-800" : "text-slate-400"}`}>
                          {step.label}
                        </span>
                      </div>
                    );
