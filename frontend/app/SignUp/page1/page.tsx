          ...
          <div className="w-full max-w-4xl bg-[#0e3b44]/45 backdrop-blur-md border border-white/20 rounded-[2.5rem] p-6 md:p-12 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] flex flex-col gap-8 transition-all duration-500 hover:border-white/25">
            ...
            <div className="flex justify-center w-full my-4">
              <button
                type="button"
                onClick={addVehicle}
                className="bg-linear-to-r from-cyan-400 to-teal-400 text-white font-bold py-3.5 px-10 rounded-full shadow-lg transition-all duration-300 hover:opacity-90 active:scale-95 text-center text-base cursor-pointer select-none outline-none border-none"
              >
                + Add Another Vehicle
              </button>
            </div>
