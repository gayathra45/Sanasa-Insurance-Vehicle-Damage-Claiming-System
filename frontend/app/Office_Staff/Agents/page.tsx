      ...
      {selectedAgentDetails && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs animate-fade-in">
          <div className="bg-white rounded-2xl w-full max-w-4xl shadow-xl border border-slate-200 overflow-hidden transform scale-100 transition-all animate-scale-up max-h-[90vh] flex flex-col">
            ...
            {/* Modal Header */}
            <div className="px-8 py-6 border-b border-slate-155 flex justify-between items-center text-slate-800 flex-shrink-0 bg-white">
              <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-655 bg-transparent border-none outline-none cursor-pointer transition-colors p-2 rounded-full hover:bg-slate-100"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="w-5 h-5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                </svg>
            ...
            <div className="p-8 overflow-y-auto grid grid-cols-1 md:grid-cols-2 gap-8 bg-white flex-1">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="bg-slate-50/50 rounded-2xl p-6 border border-slate-100 flex flex-col gap-4">
                  <h3 className="text-xs font-bold text-slate-755 uppercase tracking-wider select-none border-b border-slate-200/60 pb-2">
