            ...
            filteredVehicles.map((v, idx) => (
              <View key={idx} style={styles.vehicleCard}>
                ...
                <View style={styles.cardHeader}>
                  <View style={[styles.iconBox, { backgroundColor: getVehicleTheme(v.vehicleType).bg, borderColor: getVehicleTheme(v.vehicleType).border }]}>
                    <MaterialCommunityIcons name={getVehicleTheme(v.vehicleType).icon as any} size={28} color={getVehicleTheme(v.vehicleType).color} />
                  </View>
