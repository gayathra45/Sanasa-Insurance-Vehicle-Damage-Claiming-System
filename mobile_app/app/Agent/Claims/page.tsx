  ...
  const handleSnapInspectionPhoto = async () => {
    ...
    if (!result.canceled && result.assets && result.assets.length > 0) {
      try {
        ...
        Alert.alert("Error", "Failed to compress captured photo.");
      }
    }
  };
  ...
  const handlePickInspectionPhoto = async () => {
    ...
    if (!result.canceled && result.assets && result.assets.length > 0) {
      try {
        ...
        Alert.alert("Error", "Failed to compress selected photo.");
      }
    }
  };
                    ...
                    return (
                      ...
                      <View style={{ backgroundColor: "#f8fafc", borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                        <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                          <View style={{ width: 8, height: 8, borderRadius: 4, backgroundColor: statusCfg.color }} />
                          <Text style={{ fontSize: 12, fontWeight: "800", color: "#1e293b", textTransform: "uppercase", letterSpacing: 0.3 }}>
                            Claim Status
                          </Text>
                        </View>
                        <View style={{ backgroundColor: statusCfg.bg, borderColor: statusCfg.border, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 }}>
                          <Text style={{ fontSize: 11, fontWeight: "800", color: statusCfg.color }}>
                            {statusCfg.text}
                          </Text>
                        </View>
                      </View>
